...
def main():
    ...
    try:
        ...
        if menu == "📊 Dashboard":
            ...
            with c1:
                # Border=True sayesinde buton ve rakam aynı kutunun içinde kalır
                with st.container(border=True):
                    st.markdown(f'<div class="stat-label">İşlerin</div><div class="stat-val" style="margin-bottom:10px;">{my_total}</div>', unsafe_allow_html=True)
